...
Разработка информационной системы начинается с проектирования диаграммы вариантов использования (use-case diagram), отображающей действующие лица данной системы: покупатель, менеджер по продажам, менеджер по закупкам, курьер.
